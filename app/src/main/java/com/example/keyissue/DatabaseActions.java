...
public class DatabaseActions extends AsyncTask<String,Void,String>
{
    ...
    protected String doInBackground(String... params)
    {
        ...
        else if (type.equals("issue_key_for_a_person"))
        {
            String login_url = base_url + "issue_key_for_a_person.php";
            try {
                String key_name = params[1];
                String key_secret = params[2];

                String issued_by_name = params[3];
                String issued_by_roll = params[4];
                String issued_by_secret = params[5];
                ...
                String post_data = URLEncoder.encode("key_name", "UTF-8") + "=" + URLEncoder.encode(key_name, "UTF-8") + "&"
                        + URLEncoder.encode("key_secret", "UTF-8") + "=" + URLEncoder.encode(key_secret, "UTF-8")  + "&"
                        + URLEncoder.encode("issued_by_name", "UTF-8") + "=" + URLEncoder.encode(issued_by_name, "UTF-8")  + "&"
                        + URLEncoder.encode("issued_by_roll", "UTF-8") + "=" + URLEncoder.encode(issued_by_roll, "UTF-8")  + "&"
                        + URLEncoder.encode("issued_by_secret", "UTF-8") + "=" + URLEncoder.encode(issued_by_secret, "UTF-8");
        ...
        else if (type.equals("list_issued_keys_history"))
        {
            String login_url = base_url + "list_issued_keys_history.php";
            try {
        ...
        else if (type.equals("get_key_issue_history_details"))
        {
            String login_url = base_url + "get_key_issue_history_details.php";
            try {
                String id = params[1];
        ...
        else if (type.equals("check_key_issued_for_returning"))
        {
            String login_url = base_url + "check_key_issued_for_returning.php";
            try {
                String key_name = params[1];
                String key_secret = params[2];
        ...
        else if (type.equals("check_if_key_is_authorized"))
        {
            String login_url = base_url + "check_if_key_is_authorized.php";
            try {
                String key_name = params[1];
                String key_secret = params[2];
        ...
        else if (type.equals("get_contact_no_of_person"))
        {
            String login_url = base_url + "get_contact_no_of_person.php";
            try {
        ...
        else if (type.equals("insert_invalid_students_in_db"))
        {
            String login_url = base_url + "insert_invalid_students_in_db.php";
            try {
        ...
        else if (type.equals("handling_private_keys"))
        {
            String login_url = base_url + "handling_private_keys.php";
            try {
                String key_name = params[1];
                String roll_no = params[2];
